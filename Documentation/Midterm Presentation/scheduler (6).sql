...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2020 at 01:09 AM
...
INSERT INTO `courses` (`CID`, `title`, `course`, `PROGRAM`, `is_active`, `required_RID`, `num_credits`, `contact_hours`, `semester_offered`) VALUES
(20, 'Digital Logic Fundamentals', 'EGC220', 'CE', 1, 0, 3, 0, ''),
(21, 'Digital Logic Lab', 'EGC221', 'CE', 1, 0, 1, 0, ''),
(22, 'C/C++ Programming', 'EGC251', 'CE', 1, 0, 3, 0, ''),
(23, 'Digital Systems Design', 'EGC320', 'CE', 1, 0, 3, 0, ''),
(24, 'Microcontroller System Design', 'EGC331', 'CE', 1, 0, 3, 0, ''),
(25, 'Digital Systems Design', 'EGC320', 'CE', 1, 0, 3, 0, '');
...
--
ALTER TABLE `courses`
  ADD CONSTRAINT `courses_ibfk_1` FOREIGN KEY (`PROGRAM`) REFERENCES `programs` (`PROGRAM`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `user_data`
  ADD CONSTRAINT `user_data_ibfk_1` FOREIGN KEY (`PID`) REFERENCES `permissions` (`PID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `user_data_ibfk_2` FOREIGN KEY (`PROGRAM`) REFERENCES `programs` (`PROGRAM`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `user_schedule`
  ...
  ADD CONSTRAINT `user_schedule_ibfk_2` FOREIGN KEY (`SEID`) REFERENCES `semester` (`SEID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
